...
const prompts: Record<ThinkingStage | string, string> = {
...
export function getPrompt(
    nextStage: ThinkingStage,
    isImplementationRefinement: boolean,
    requestedLoopbackStage?: RequestedStageOverride,
    userClarification?: string
): string {
    let promptKey: string = nextStage;
